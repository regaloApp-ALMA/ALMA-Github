...
import { Plus, Leaf, Apple, Clock, Sparkles, Camera } from 'lucide-react-native';
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, isDarkMode && styles.modalContentDark]}>
            ...
            <TouchableOpacity style={[styles.modalOption, isDarkMode && styles.modalOptionDark]} onPress={handleAddBranch}>
            ...
            <TouchableOpacity style={[styles.modalOption, isDarkMode && styles.modalOptionDark]} onPress={handleAddMemory}>
            ...
            <TouchableOpacity style={[styles.modalOption, isDarkMode && styles.modalOptionDark]} onPress={handleTimeCapsule}>
